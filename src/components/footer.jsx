export default function Footer(){
    ...
    return(
        <>
        <selection className="grid grid-cols-3 pt-4 bg-yellow-100 w-full pb-20">
        <div className="pl-9 flex"><i class='bx bxs-envelope  text-3xl'></i>
        <h1 className="text-center text-xl pl-4">Sign up to Newsletter</h1></div>
        <div>
    ...
    <selection className="grid grid-cols-4 pt-9 pb-5">
